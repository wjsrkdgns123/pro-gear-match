// Set nationality + profileUrl for Overwatch 2 players from Liquipedia
// Usage: node scripts/set_ow2_nationality.mjs
...
const dataPath = path.join(process.env.USERPROFILE || process.env.HOME, 'Downloads', 'ow2_nationality.json');
